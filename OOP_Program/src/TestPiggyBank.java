...
public class TestPiggyBank {
	...
	public static void sizeOfPiggyBank() {
		...
		System.out.println("Size of your PiggBank: " + pb.getPiggyBank());
		inputCoin();
	...
	public static void inputCoin() {
		while (true) {
			System.out.println("\n====================");
			System.out.println("Menu of PigyBank");
			System.out.println("\n====================");
			System.out.println("[1] one baht.");
			System.out.println("[2] two baht.");
			System.out.println("[5] five baht.");
			System.out.println("[10] ten baht.");
			System.out.println("\n====================");
